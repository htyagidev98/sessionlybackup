        ...
        if (coupons && coupons.length > 0) {
            ...
            for (let i = 0; i < coupons.length; i++) {
                ...
                let couponObj = {
                    ...
                    createdAt: moment(coupon.createdAt).format("DD-MM-YYYY h:mm:ss A"),
                    updatedAt: moment(coupon.updatedAt).format("DD-MM-YYYY h:mm:ss A"),
                };
                couponsData.push(couponObj);
            }
             res.status(200).json({
                status: "success", counts: couponsData.length,
                responseMessage: "Successfully", responseData: couponsData,
            });
        } else {
             res.status(404).json({
